...
class InternTaskControllerTest {
    ...
    void taskDetail_exposesSubmissionHistoryForListGroup() throws Exception {
        ...
        when(taskService.findForInternTaskDetail("intern", 7L)).thenReturn(task);
        when(taskService.findSubmissionHistoryForInternTask("intern", 7L)).thenReturn(List.of(r1, r2));
